...
public class DisruptorService {
     ...
     * @param reviewEventTask  the review result info
     */
    public void sendMsg(Event event, ReviewConfigInfo reviewConfigInfo, ReviewEventTask reviewEventTask) {
        ...
        try {
            ...
            messageModel.setReviewEventTask(reviewEventTask);
